...
CREATE TABLE matiere_formateur( -- table de liaison formateur peut enseigner plusieurs matières qui sont différentes -- 
...
-- Pas utile de créer une table EmploiDuTemps car on l'exploitera dans l'application 
